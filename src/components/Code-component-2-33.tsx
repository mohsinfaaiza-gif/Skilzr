...
import { Search, Filter, TrendingUp, Users, BookOpen, Palette, Code, Music, Languages, Fitness } from 'lucide-react';
...
export function SkillMatching() {
  ...
  const categories = [
    ...
    { id: 'fitness', name: 'Fitness', icon: Fitness, color: 'bg-red-500' },
  ];
